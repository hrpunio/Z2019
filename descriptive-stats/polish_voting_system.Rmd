...
Well known observed phenomenon of proportional scheme is concentration of votes at the top (or sometimes bottom) of the list. Elections in Poland is no exception to this.
...
BTW there are `r kkNN` candidates from 4RA (out of 5100 in total). The readibility if a chart is 
